...
This repository contains the worked sample app for the [Retrieving Config Values](https://grails.apache.org/guides/grails-quickcasts-retrieving-config-values/4/guide/index.html) guide on the Apache Grails site.
